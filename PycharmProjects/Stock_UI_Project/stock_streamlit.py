...
ticker_symbol = st.sidebar.text_input("Enter Stock Ticker (e.g., AAPL, MSFT)", value="TSLA")
...
data['MA'] = data['Close'].rolling(window=ma_window).mean()# Calculate Moving Average
